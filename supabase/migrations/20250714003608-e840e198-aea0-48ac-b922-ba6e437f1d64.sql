-- Update the process_email_rules function to use consistent variable naming
-- This ensures the variable names match what the frontend expects
  ...
  LOOP
    ...
    CASE rule_record.recipient_type
      WHEN 'assigned_to' THEN
        IF TG_TABLE_NAME = 'incidents' THEN
          recipient_email := (flattened_data ->> 'assigned_to_admin_email');
        ELSE
