-- Fix email rules to only trigger when specific conditions are met
...
BEGIN
  ...
  LOOP
    ...
    IF TG_OP = 'INSERT' THEN
      should_send_email := rule_record.rule_type IN ('task_created', 'task_assigned', 'incident_created', 'incident_assigned');
