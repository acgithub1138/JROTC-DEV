-- Create enums for competition system
...
CREATE TYPE public.comp_placement AS ENUM (
  'first',
  'second', 
  'third',
  'fourth',
...
CREATE TYPE public.jrotc_program AS ENUM (
  'air_force',
  'army',
  'navy',
  'marine_corps'
...
ALTER TABLE public.competitions ADD COLUMN school_id UUID REFERENCES public.schools(id);
ALTER TABLE public.competitions ADD COLUMN comp_type jrotc_program;
ALTER TABLE public.competitions ADD COLUMN teams UUID[];
ALTER TABLE public.competitions ADD COLUMN cadets UUID[];
ALTER TABLE public.competitions ADD COLUMN armed_regulation comp_placement;
ALTER TABLE public.competitions ADD COLUMN armed_exhibition comp_placement;
ALTER TABLE public.competitions ADD COLUMN armed_color_guard comp_placement;
ALTER TABLE public.competitions ADD COLUMN armed_inspection comp_placement;
ALTER TABLE public.competitions ADD COLUMN unarmed_regulation comp_placement;
ALTER TABLE public.competitions ADD COLUMN unarmed_exhibition comp_placement;
ALTER TABLE public.competitions ADD COLUMN unarmed_color_guard comp_placement;
ALTER TABLE public.competitions ADD COLUMN unarmed_inspection comp_placement;
