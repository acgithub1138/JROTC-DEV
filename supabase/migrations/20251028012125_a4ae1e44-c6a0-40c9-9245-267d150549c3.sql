-- Fix queue_email function to initialize school_record before use
...
BEGIN
  ...
  -- Initialize school_record with NULL values
  school_record := ROW(NULL, NULL);
  ...
  IF school_id_param IS NOT NULL THEN
    ...
    -- If not found, school_record will keep its initialized NULL values
  END IF;
