-- Drop and recreate the view to fix event formatting with HTML line breaks
DROP VIEW IF EXISTS public.competition_registration_email_data;

CREATE VIEW public.competition_registration_email_data AS
SELECT 
