-- Rename judge_assignments_view to cp_judge_assignment_view
DROP VIEW IF EXISTS judge_assignments_view;

CREATE OR REPLACE VIEW cp_judge_assignment_view AS
SELECT 
  j.user_id,
  j.id as judge_id,
...
GRANT SELECT ON cp_judge_assignment_view TO authenticated;