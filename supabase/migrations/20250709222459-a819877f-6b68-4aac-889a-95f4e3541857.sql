...
BEGIN
  ...
  -- Loop through all active email rules for this table and INSERT trigger event
  FOR rule_record IN 
  ...
  LOOP
    RAISE NOTICE 'Processing email rule "%" for INSERT event', rule_record.name;
