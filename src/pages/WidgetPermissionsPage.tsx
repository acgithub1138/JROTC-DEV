...
const WidgetPermissionsPage: React.FC = () => {
  ...
  return <ProtectedRoute module="widget_permissions" requirePermission="read">
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <DashboardWidgetsTable modules={modules} actions={actions} rolePermissions={localPermissions} isCellPending={isCellPending} handlePermissionChange={handlePermissionChange} />
          </CardContent>
        </Card>
      </div>
    </ProtectedRoute>;
