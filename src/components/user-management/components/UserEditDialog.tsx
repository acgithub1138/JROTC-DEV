...
export const UserEditDialog = ({
  ...
  return <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input id="edit-firstName" value={editingUser.first_name} onChange={e => setEditingUser({
                          ...editingUser,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="edit-lastName" value={editingUser.last_name} onChange={e => setEditingUser({
                          ...editingUser,
                      ...
                      {canResetPassword(editingUser) && <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex gap-2">
                                <div className="relative flex-1">
                                  <Input id="new-password" type={showPassword ? "text" : "password"} value={newPassword} onChange={e => setNewPassword(e.target.value)} placeholder="Enter new password (min 6 characters)" minLength={6} />
                            ...
                            {newPassword && <Button type="button" variant="outline" onClick={() => setPasswordResetConfirmOpen(true)} className="w-full">
                                Reset Password
                              </Button>}
                          </div>
                        </>}
      ...
      {passwordResetConfirmOpen && <Dialog open={passwordResetConfirmOpen} onOpenChange={setPasswordResetConfirmOpen}>
          <DialogContent>
            <DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-2">
                ...
                <Button onClick={handlePasswordReset} disabled={passwordResetLoading} className="bg-red-600 hover:bg-red-700">
