...
export const ViewScoreSheet: React.FC = () => {
  ...
  const { canViewDetails } = useCompetitionResultsPermissions();
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button 
          variant="outline" 
          onClick={() => navigate(`/app/competition-portal/competition-details/${competitionId}/results`)} 
