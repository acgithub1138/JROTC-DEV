    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">The competition you're looking for doesn't exist or has been removed.</p>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    <strong>Location:</strong> {competition.address}, {competition.city}, {competition.state} {competition.zip}
                  </span>
                </div>
                ...
                {competition.hosting_school && (
                  <div className="flex items-center gap-2">
                    ...
                    <span><strong>Hosting School:</strong> {competition.hosting_school}</span>
                  </div>
                )}
                ...
                {competition.max_participants && (
                  <div className="flex items-center gap-2">
                    ...
                    <span><strong>Max Participants:</strong> {competition.max_participants}</span>
                  </div>
                )}
                ...
                {competition.registration_deadline && (
                  <div className="flex items-center gap-2">
                    ...
                    <span><strong>Registration Deadline:</strong> {format(new Date(competition.registration_deadline), 'MMM d, yyyy')}</span>
                  </div>
                )}
            ...
            <CardContent className="space-y-4">
              {events.length === 0 ? (
                ...
                events.map(event => {
                  ...
                  return (
                    <div key={event.id} className={`border rounded-lg p-4 ${hasConflict ? 'border-destructive bg-destructive/5' : ''}`}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              This will cancel your registration for all events and cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      {showSopText && competition.sop_text && (
        <AlertDialog open={showSopText} onOpenChange={setShowSopText}>
          <AlertDialogContent className="sm:max-w-[600px] max-h-[80vh]">
            ...
            <AlertDialogFooter>
              <AlertDialogAction onClick={() => setShowSopText(false)}>
                Close
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
