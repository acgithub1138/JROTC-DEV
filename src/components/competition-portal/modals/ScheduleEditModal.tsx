...
export const ScheduleEditModal = ({ 
  ...
  const { updateScheduleSlot, getAvailableSchools, refetch } = useCompetitionSchedule(competitionId);
                    ...
                    {slot.assignedSchool ? (
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleRemoveAssignment(slot.time)}
                      ...
                      <Select onValueChange={(schoolId) => handleAssignSchool(slot.time, schoolId)}>
