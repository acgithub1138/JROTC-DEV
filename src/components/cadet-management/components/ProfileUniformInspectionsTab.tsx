...
export const ProfileUniformInspectionsTab = ({ profileId }: ProfileUniformInspectionsTabProps) => {
  const { timezone } = useSchoolTimezone();

  const { data: uniformInspections = [], isLoading } = useQuery({
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader className="flex-shrink-0">
        <CardTitle>Uniform Inspections</CardTitle>
      </CardHeader>
