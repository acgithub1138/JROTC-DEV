  ...
  return <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {cadet.flight ? `Flight ${cadet.flight}` : 'No flight assigned'}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Start Year</CardTitle>
          <Calendar className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">{cadet.start_year || 'N/A'}</div>
          <p className="text-xs text-muted-foreground">
            {cadet.role || 'Cadet'}
          </p>
        </CardContent>
