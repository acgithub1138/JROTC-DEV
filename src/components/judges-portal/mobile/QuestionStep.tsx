...
export const QuestionStep = ({
  ...
  const isInputRequired = ['number', 'dropdown', 'text'].includes(field.type) || 
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-[2] p-6 overflow-y-auto">
          <div className="mb-6">
            ...
            {field.fieldInfo && (
              <p className="text-muted-foreground">{field.fieldInfo}</p>
            )}
          </div>
        ...
        <div className="flex-1 p-6 border-t bg-muted/30">
