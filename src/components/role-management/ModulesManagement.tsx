    ...
    <Card>
      ...
      <CardContent>
                ...
                <TableCell>
                  {editingModule === module.id ? (
                    <Button
                      ...
                      className="flex items-center gap-2"
                    >
                      {React.createElement(getIconComponent(editForm.icon || 'FileText'), { className: "h-4 w-4" })}
        ...
        <IconSelectionModal
          ...
          selectedIcon={iconModalType === 'create' ? formData.icon : (editForm.icon || '')}
