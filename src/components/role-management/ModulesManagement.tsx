            ...
            {modules.map(module => <TableRow key={module.id}>
                ...
                <TableCell className="text-right">
                  {editingModule === module.id ? <div className="flex justify-end space-x-2">
                      ...
                      <Button size="sm" variant="outline" onClick={() => handleEdit(module)} disabled={updateMutation.isPending}>
                        <Edit2 className="w-4 h-4" />
                      </Button>
                      <Button size="sm" variant="destructive" onClick={() => deleteMutation.mutate(module.id)} disabled={deleteMutation.isPending}>
