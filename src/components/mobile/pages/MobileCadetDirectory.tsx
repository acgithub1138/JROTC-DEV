...
export const MobileCadetDirectory: React.FC = () => {
  ...
  const { cadets, loading, getCadetStats } = useCadets();
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-border bg-card">
        <div className="relative">
          ...
          <Input
            placeholder="Search cadets, ranks, flights..."
            value={searchTerm}
        ...
        {filteredCadets.map((cadet) => (
          <Card 
            ...
            className={`bg-card border-border transition-colors ${
              canView ? 'cursor-pointer hover:bg-muted/50' : ''
            }`}
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {cadet.flight && (
                    <p className="text-xs text-muted-foreground mb-2">{cadet.flight}</p>
                  )}
