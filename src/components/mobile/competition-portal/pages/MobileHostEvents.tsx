  ...
  return <div className="p-4 space-y-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          ...
          <Button size="sm" onClick={() => navigate(`/mobile/competition-portal/manage/${competitionId}/events/add`)} className="h-8 w-8 p-0">
            <Plus size={16} />
          </Button>
      </div>
      ...
      <div className="space-y-3">
        {events.length > 0 ? events.map(event => <Card key={event.id} className="bg-card border-border hover:bg-muted/50 transition-colors">
              <CardContent className="p-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="outline" size="sm" className="text-xs h-7 w-7 p-0" onClick={() => navigate(`/mobile/competition-portal/manage/${competitionId}/events/${event.id}/edit`)}>
                      <Settings size={12} />
                    </Button>
                  </div>
                </div>
