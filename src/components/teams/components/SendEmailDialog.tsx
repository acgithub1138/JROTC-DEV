...
export const SendEmailDialog = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const memberEmails = team.team_members.map(member => {
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Textarea id="body" value={body} onChange={e => setBody(e.target.value)} placeholder="Enter your message here..." rows={10} className="resize-none" required />
