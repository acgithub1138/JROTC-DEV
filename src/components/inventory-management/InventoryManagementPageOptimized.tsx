...
import { useOptimizedInventoryPermissions } from '@/hooks/useOptimizedInventoryPermissions';
...
const InventoryManagementPageOptimized = () => {
  ...
  // Centralized permissions - only one call to permission context
  ...
  if (!permissions.canAccess && !permissions.isLoading) {
    return (
      <div className="p-6">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h2 className="text-lg font-semibold text-yellow-800 mb-2">Access Denied</h2>
          <p className="text-yellow-600">You don't have permission to access inventory management.</p>
        </div>
      </div>
    );
  }
...
export default InventoryManagementPageOptimized;