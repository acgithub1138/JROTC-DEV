        ...
        <table className="w-full caption-bottom text-sm">
          <thead className="[&_tr]:border-b">
            <tr className="border-b transition-colors hover:bg-muted/50">
              ...
              <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Qty Total</th>
              <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Qty Issued</th>
          ...
          <tbody className="[&_tr:last-child]:border-0">
            {parsedData.map((item, index) => (
              <tr key={index} className={`border-b transition-colors hover:bg-muted/50 ${!item.isValid ? 'bg-red-50' : ''}`}>
                ...
                <td className="p-4 align-middle">{item.data.qty_total || 0}</td>
                <td className="p-4 align-middle">{item.data.qty_issued || 0}</td>
                <td className="p-4 align-middle">{item.data.location || 'N/A'}</td>
                <td className="p-4 align-middle">
