...
export const airForceArmedExhibition: JsonField[] = [
  ...
  { id: '14', name: 'MILITARY Flavor', type: 'scoring_scale', pointValue: 40, penalty: false, scaleRanges: { poor: { min: 0, max: 32 }, average: { min: 33, max: 40 }, exceptional: { min: 40, max: 40 } } },
