    ...
    return <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[...Array(3)].map((_, index) => <div key={index} className="flex items-start space-x-3 p-3 rounded-lg">
      ...
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            {taskCounts.overdue > 0 && <span className="flex items-center text-destructive">
          ...
          {tasks.length > 0 ? tasks.map(task => <div key={task.id} className="flex items-start space-x-3 p-3 hover:bg-muted/50 transition-colors rounded-lg py-[4px]">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    {task.due_date && <span className="text-xs text-muted-foreground flex items-center ml-2">
