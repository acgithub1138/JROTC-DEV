  ...
  return <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          {sourceTable && <RecordSelector tableName={sourceTable} selectedRecordId={selectedRecordId} onRecordSelect={handleRecordSelect} />}

          <PreviewContent subject={subject} body={body} recordData={selectedRecordData} />
