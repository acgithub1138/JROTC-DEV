...
export const StandardTableWrapper = React.forwardRef<
  HTMLDivElement,
  StandardTableWrapperProps
>(({ 
  title, 
  description, 
  searchValue, 
...
export const StandardTableHeader = React.forwardRef<
...
export const StandardTableBody = React.forwardRef<
  HTMLTableSectionElement,
  StandardTableBodyProps
>(({ children, emptyMessage = "No data found", emptyIcon, colSpan = 8 }, ref) => (
  <TableBody ref={ref}>
