...
const AnnouncementManagementPage = () => {
  const { canCreate, canEdit, canDelete, canViewDetails } = useTablePermissions('announcements');
  ...
  return (
    <div className="p-6 space-y-6">
                    ...
                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                      ...
                      {announcement.expire_date && (
                        <div className="flex items-center gap-1">
                          ...
                          Expires {format(new Date(announcement.expire_date), 'MMM d, yyyy')}
                        </div>
                      )}
                    </div>
                  </div>
      ...
      <AlertDialog 
        ...
        onOpenChange={() => setDeleteAnnouncementId(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
