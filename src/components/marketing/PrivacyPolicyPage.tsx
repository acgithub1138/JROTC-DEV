    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-6 text-muted-foreground">
          <p>
            This privacy policy applies to the JROTC Command & Control Center app (hereby referred to as "Application") for mobile devices that was created by Carey Unlimited (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
          </p>
          ...
          <section>
            ...
            <p className="mt-4">
              For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to name, email, phone number, email, user id. The information that the Service Provider request will be retained by them and used as described in this privacy policy.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">Third Party Access</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">Opt-Out Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">Your Consent</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at google_dev@careyunlimited.com.
            </p>
          </section>
